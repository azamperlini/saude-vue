        ...
        <article class="content-article">
          <div class="title-article">
            ...
            <router-link to="/medical-records/edit/allergy">
              <button @click="redirectTab" class="btn-tab">ALERGIAS</button>
            </router-link>
            <router-link to="/medical-records/edit/medicineContinuours">
              <button class="btn-tab fixed">MEDICAMENTOS DE USO CONTÍNUO</button>
            </router-link>
          </div>
          <div class="form-body">
            <form class="form-content">
              <div class="inputsBox">
                <div class="inputBoxCol3">
                  <label>Faz Uso de Medicamentos Contínuos?</label><br>
                  <input
