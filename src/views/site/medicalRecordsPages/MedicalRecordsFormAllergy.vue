    ...
    <main class="content">
      <div class="navMR">
        ...
        <ul>
          ...
          <router-link to="/medical-records/edit"><li>Editar</li></router-link>
      ...
      <section class="content-forms">
        ...
        <article class="content-article">
            <div class="title-article">
              <router-link to="/medical-records/edit">
                <button class="btn-tab">DADOS PESSOAIS</button>
              </router-link>
              <router-link to="/medical-records/edit/address">
                <button class="btn-tab">ENDEREÇO</button>
              </router-link>
              <router-link to="/medical-records/edit/contact">
                <button class="btn-tab">CONTATOS</button>
              </router-link>
              <router-link to="/medical-records/edit/blood">
                <button class="btn-tab">INFORMAÇÕES SANGUINEAS</button>
              </router-link>
              <router-link to="/medical-records/edit/allergy">
                <button class="btn-tab fixed">ALERGIAS</button>
              </router-link>
              <router-link to="/medical-records/edit/medicineContinuours">
                <button class="btn-tab">MEDICAMENTOS DE USO CONTÍNUO</button>
              </router-link>
            </div>
            <div class="form-body">
                <form class="form-content">
                    <div class="inputsBox">
                        <div class="inputBoxCol3">
                            <label>Possui Alergia a Alimentos?</label><br>
                            <input
                    ...
                    <div class="inputsBox">
                        <div class="inputBoxCol3">
                            <label>Possui Alergia a Medicamentos?</label><br>
                            <input
                            class="inputCheck inputCheck2"
                            type="checkBox"
                            >
                    ...
                    <div class="inputsBox">
                        <div class="inputBoxCol3">
                            <label>Possui Alergia a Picadas de Insetos?</label><br>
                            <input
                            class="inputCheck inputCheck2"
                            type="checkBox"
                            >
