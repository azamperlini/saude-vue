  ...
  <section class="content-forms">
    ...
    <article class="content-article">
      <div class="title-article">
        ...
        <a href="#">
          <button
            class="btn-tab" :class="{fixed: currentItem === 'intershipRecord'}"
            @click.prevent="redirectTab('intershipRecord')">
            REGISTRO DE ESTÁGIO
          </button>
        </a>
      </div>
      <div class="form-body">
        ...
        <FormIntershipRecord v-show="currentItem === 'intershipRecord'" />
      </div>
    </article>
  </section>
</template>
...
import FormIntershipRecord from './FormIntershipRecord.vue';

export default {
  name: 'HealthAgentProfile',
  data() {
    return {
